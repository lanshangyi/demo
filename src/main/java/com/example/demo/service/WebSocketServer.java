...
public class WebSocketServer {
    ...
    public void onOpen(Session session, @PathParam("sid") String sid) {
        ...
        if (userSocket.containsKey(this.sid)) {
        	...
        	CopyOnWriteArraySet<WebSocketServer> webSocketSet_ = new CopyOnWriteArraySet<WebSocketServer>();
...
//		}
    ...
    public void onMessage(String message, Session session) {
    	...
    	for(String sidString : userSocket.keySet()) {
    		CopyOnWriteArraySet<WebSocketServer> copyOnWriteArraySet = userSocket.get(sidString);
    ...
    public static Boolean sendInfo(String message,@PathParam("sid") String sid) {
    	...
    	if (userSocket.containsKey(sid)) {
            ...
            for (WebSocketServer WS : userSocket.get(sid)) {
